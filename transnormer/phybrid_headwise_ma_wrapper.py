...
# from transnormer.headwise_phybrid_model import TransnormerDecoderLayer #main change
from transnormer.headwise_ma_phybrid_model import TransnormerDecoderLayer #main change
...
class TransnormerTransformerHybridModelWrapper(nn.Module, GenerationMixin):
    ...
    def __init__(self, checkpoint_path, transformer_model, transnormer_config, attn_layers, dtype, init_with_kqvo, load_from_hub=False, **kwargs):
        ...
        self.slopes = self._build_slope_tensor(transnormer_config.num_attention_heads//2) #because only half 
